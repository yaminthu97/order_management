...
class SearchNoshiDetail implements SearchNoshiDetailInterface
{
    /**
     * デフォルトの検索条件
     */
    ...
    public function setConditions($query, $conditions): Builder
    {
        ...
        // 熨斗詳細ID
        if(isset($conditions['m_noshi_detail_id'])){
            $query->where('m_noshi_detail_id', $conditions['m_noshi_detail_id']);
        }
