...
class SearchDeliveryTimeHope implements SearchDeliveryTimeHopeInterface
{
    /**
     * デフォルトの検索条件
     */
    ...
    {
        $query = DeliveryTimeHopeModel::query();
    ...
    public function setConditions($query, $conditions): Builder
    {
        ...
        // delivery_time_hopeでは、delete_flgは存在しないため、コメントアウト
