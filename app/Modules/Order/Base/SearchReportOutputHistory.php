...
use App\Models\Order\Base\ReportOutputHistoryModel;
use Illuminate\Database\Eloquent\Builder;
use InvalidArgumentException;

class SearchReportOutputHistory implements SearchReportOutputHistoryInterface
{
    /**
     * デフォルトの検索条件
     */
    ...
    {
        $query = ReportOutputHistoryModel::query();
