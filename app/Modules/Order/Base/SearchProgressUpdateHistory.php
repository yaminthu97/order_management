...
use App\Models\Order\Base\ProgressUpdateHistoryModel;
use Illuminate\Database\Eloquent\Builder;
use InvalidArgumentException;
use Illuminate\Pagination\Paginator;

class SearchProgressUpdateHistory implements SearchProgressUpdateHistoryInterface
{
    /**
     * デフォルトの検索条件
     */
    ...
    {
        $query = ProgressUpdateHistoryModel::query();
