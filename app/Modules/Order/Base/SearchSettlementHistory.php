...
use App\Models\Order\Base\SettlementHistoryModel;
use Illuminate\Database\Eloquent\Builder;
use InvalidArgumentException;

class SearchSettlementHistory implements SearchSettlementHistoryInterface
{
    /**
     * デフォルトの検索条件
     */
    ...
    {
        $query = SettlementHistoryModel::query();
