...
class StoreAmiPageAttachment implements StoreAmiPageAttachmentInterface
{
    /**
    * ESMセッション管理クラス
    */
    ...
    public function execute(array $data)
    {
        ...
        try {
            ...
            $new = DB::transaction(function () use ($data) {
                ...
                $new = new AmiPageAttachmentItemModel();
                $errors = [];
                // データを設定

                $new->m_ami_page_id = $data['m_ami_page_id'];
                $new->m_ami_attachment_item_id = $data['m_ami_attachment_item_id'];
                $new->category_id = $data['attachment_item_category_id'];
