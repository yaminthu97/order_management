...
class SearchDeliveryTypes implements SearchDeliveryTypesInterface
{
    /**
     * デフォルトの検索条件
     */
     ...
     * デフォルトのセレクトリスト用キー
     */
    protected $selectionKey = 'm_delivery_types_id';

    /**
     * デフォルトのセレクトリスト用値
     */
    protected $selectionValue = 'm_delivery_type_name';
