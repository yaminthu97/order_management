...
class EstimateOut extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:EstimateOut {t_execute_batch_instruction_id : バッチ実行指示ID} {json? : JSON化した引数}';
     ...
     * @var string
     */
    protected $description = '受注から見積書を作成し、バッチ実行確認へと出力する';
    ...
    // for report name
    protected $reportName = TemplateFileNameEnum::EXPXLSX_ESTIMATE->value;
    ...
    public function handle()
    {
        ...
        try{
            ...
            $templateFileName = $this->getTemplateFileName->execute($this->reportName, $accountId);    // template file name from database
