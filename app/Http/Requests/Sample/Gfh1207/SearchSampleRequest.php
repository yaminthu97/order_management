...
use App\Http\Requests\Sample\Base\SearchSampleRequest as BaseSearchSampleRequest;
use Illuminate\Support\Facades\Log;

class SearchSampleRequest extends BaseSearchSampleRequest
{
    /**
    ...
    public function getSearchOptions(): array
    {
        return [
            ...
            'limit' => $this->input('page_list_count', config('esm.default_page_size.cc')),
