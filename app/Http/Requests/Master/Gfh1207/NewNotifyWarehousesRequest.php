...
use App\Http\Requests\Master\Base\NewNotifyWarehousesRequest as BaseNewNotifyWarehousesRequest;
use Illuminate\Support\Facades\DB;
use Illuminate\Validation\Rule;
use Symfony\Component\Routing\Exception\InvalidParameterException;

class NewNotifyWarehousesRequest extends BaseNewNotifyWarehousesRequest
{
    /**
    ...
    public function rules(): array
    {
        try {
            ...
            $uniqueRule = Rule::unique('m_warehouses');
        } catch (\Exception $e) {
            $uniqueRule = [];
        }
