...
use App\Http\Requests\Master\Base\SearchItemnameTypeRequest as BaseSearchItemnameTypeRequest;

class SearchItemnameTypeRequest extends BaseSearchItemnameTypeRequest
{
    /**
