...
use App\Http\Requests\Master\Base\NewNotifyDeliveryFeesRequest as BaseNewNotifyDeliveryFeesRequest;
use Symfony\Component\Routing\Exception\InvalidParameterException;

class NewNotifyDeliveryFeesRequest extends BaseNewNotifyDeliveryFeesRequest
{
    /**
    ...
    {
        return [
            'm_delivery_fee_id'     =>  ['nullable', 'integer'],
