...
use App\Http\Requests\Master\Base\SearchPaymentTypesRequest as BaseSearchPaymentTypesRequest;

class SearchPaymentTypesRequest extends BaseSearchPaymentTypesRequest
{
    /**
