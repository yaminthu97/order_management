...
use App\Http\Requests\Master\Base\EditNotifyWarehousesRequest as BaseEditNotifyWarehousesRequest;
use Illuminate\Support\Facades\DB;
use Illuminate\Validation\Rule;
use Symfony\Component\Routing\Exception\InvalidParameterException;

class EditNotifyWarehousesRequest extends BaseEditNotifyWarehousesRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            'm_warehouses_id'     =>  ['required', 'numeric'],
