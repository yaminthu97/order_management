...
use App\Http\Requests\Order\Base\NewOrderTagMasterRequest as BaseNewOrderTagMasterRequest;
...
class NewOrderTagMasterRequest extends BaseNewOrderTagMasterRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'font_color'            => [ 'required', Rule::in(array_column(app(FontColorEnumInterface::class)::cases(), 'value')) ],
            'tag_context'           => [ 'nullable', 'string', 'max:1000' ],
            'and_or'                => [ 'required', Rule::in(array_column(app(AndOrEnumInterface::class)::cases(), 'value')) ],
            'auto_timming'          => [ 'required', Rule::in(array_column(app(AutoTimmingEnumInterface::class)::cases(), 'value')) ],
        ...
        for ($i = 1; $i <= 10; $i++) {
            ...
            $rules["cond{$i}_operator"]     = [ 'nullable', Rule::in(array_column(app(OperatorEnumInterface::class)::cases(), 'value')) ];
