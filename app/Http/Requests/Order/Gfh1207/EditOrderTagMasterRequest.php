...
use App\Http\Requests\Order\Base\EditOrderTagMasterRequest as BaseEditOrderTagMasterRequest;
use Illuminate\Validation\Rule;

class EditOrderTagMasterRequest extends BaseEditOrderTagMasterRequest
{
    /**
