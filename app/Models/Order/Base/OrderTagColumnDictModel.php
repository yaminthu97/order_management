...
/**
 * Class OrderTagColumnDictModel
 * 
 * @package App\Models
 */
class OrderTagColumnDictModel extends Model
{
    protected $table = 'm_order_tag_column_dict';
    protected $primaryKey = 'm_order_tag_column_dict_id';
