...
class DeliveryDtlModel extends Model
{
    use HasFactory;
     ...
     * 出荷明細SKUとのリレーション
     */
     public function deliveryDtlSku()
    {
        return $this->hasMany(\App\Models\Order\Base\DeliveryDtlSkuModel::class, 't_delivery_dtl_id', 't_delivery_dtl_id');
    }

    /**
     * 出荷明細付属品   とのリレーション
     */
    public function deliveryDtlAttachmentItems()
    {
        return $this->hasMany(\App\Models\Order\Base\DeliveryDtlAttachmentItemModel::class, 't_delivery_dtl_id', 't_delivery_dtl_id');
    }
    /*
     * 熨斗
     */
