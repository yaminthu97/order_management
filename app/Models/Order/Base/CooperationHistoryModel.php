...
/**
 * Class CooperationHistoryModel
 * 
 * @package App\Models
 */
class CooperationHistoryModel extends Model
{
    protected $table = 't_cooperation_history';
    protected $primaryKey = 't_cooperation_history_id';
