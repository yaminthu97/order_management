...
/**
 * Class ProgressUpdateHistoryModel
 * 
 * @package App\Models
 */
class ProgressUpdateHistoryModel extends Model
{
    protected $table = 't_progress_update_history';
    protected $primaryKey = 't_progress_update_history_id';
