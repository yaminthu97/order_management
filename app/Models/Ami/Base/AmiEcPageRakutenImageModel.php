...
/**
 * Class AmiEcPageRakutenImageModel
 * 
 * @package App\Models
 */
class AmiEcPageRakutenImageModel extends Model
{
    protected $table = 'm_ami_ec_page_rakuten_image';
    protected $primaryKey = 'm_ami_ec_page_rakuten_image_id';
