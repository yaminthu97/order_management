...
/**
 * Class AmiEcPageSkuFreeInputModel
 * 
 * @package App\Models
 */
class AmiEcPageSkuFreeInputModel extends Model
{
    protected $table = 'm_ami_ec_page_sku_free_input';
    protected $primaryKey = 'm_ami_ec_page_rakuten_sku_free_input_id';
