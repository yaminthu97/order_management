...
/**
 * Class GotoOrderAuthorizationReceptModel
 *
 * @package App\Models
 */
class GotoOrderAuthorizationReceptModel extends Model
{
    protected $table = 't_goto_order_authorization_recept';
    protected $primaryKey = 't_goto_order_authorization_recept_id';
