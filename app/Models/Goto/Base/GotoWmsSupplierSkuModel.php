...
/**
 * Class GotoWmsSupplierSkuModel
 *
 * @package App\Models
 */
class GotoWmsSupplierSkuModel extends Model
{
    protected $table = 'm_goto_wms_supplier_sku';
    protected $primaryKey = 'm_goto_wms_supplier_sku_id';
