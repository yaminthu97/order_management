...
/**
 * Class GotoOrderShipmentReceptModel
 *
 * @package App\Models
 */
class GotoOrderShipmentReceptModel extends Model
{
    protected $table = 't_goto_order_shipment_recept';
    protected $primaryKey = 't_goto_order_shipment_recept_id';
