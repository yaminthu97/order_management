...
/**
 * Class GotoItokiOrderReceptModel
 *
 * @package App\Models
 */
class GotoItokiOrderReceptModel extends Model
{
    protected $table = 't_goto_itoki_order_recept';
    protected $primaryKey = 't_goto_itoki_order_recept_id';
