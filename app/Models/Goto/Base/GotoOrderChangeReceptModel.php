...
/**
 * Class GotoOrderChangeReceptModel
 *
 * @package App\Models
 */
class GotoOrderChangeReceptModel extends Model
{
    protected $table = 't_goto_order_change_recept';
    protected $primaryKey = 't_goto_order_change_recept_id';
