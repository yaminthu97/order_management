...
/**
 * Class GotoOrderCancelReceptModel
 *
 * @package App\Models
 */
class GotoOrderCancelReceptModel extends Model
{
    protected $table = 't_goto_order_cancel_recept';
    protected $primaryKey = 't_goto_order_cancel_recept_id';
    ...
    /*
     * 項目名称マスタとのリレーション（キャンセル理由）
     */
    public function itemnameTypesCancel()
    {
    ...
    {
        return $this->belongsTo(\App\Models\Master\Base\OperatorModel::class, 'request_operator_id', 'request_operator_id');
    }
