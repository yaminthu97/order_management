...
/**
 * Class GotoWmsShippingScheduleReceptModel
 *
 * @package App\Models
 */
class GotoWmsShippingScheduleReceptModel extends Model
{
    protected $table = 't_goto_wms_shipping_schedule_recept';
    protected $primaryKey = 't_goto_wms_shipping_schedule_recept_id';
