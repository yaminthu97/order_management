...
/**
 * Class GotoPaymentSalesReceptModel
 *
 * @package App\Models
 */
class GotoPaymentSalesReceptModel extends Model
{
    protected $table = 't_goto_payment_sales_recept';
    protected $primaryKey = 't_goto_payment_sales_recept_id';
