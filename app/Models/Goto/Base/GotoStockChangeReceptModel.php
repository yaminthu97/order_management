...
/**
 * Class GotoStockChangeReceptModel
 *
 * @package App\Models
 */
class GotoStockChangeReceptModel extends Model
{
    protected $table = 't_goto_stock_change_recept';
    protected $primaryKey = 't_goto_stock_change_recept_id';
