...
/**
 * Class GotoOrderRegistReceptModel
 *
 * @package App\Models
 */
class GotoOrderRegistReceptModel extends Model
{
    protected $table = 't_goto_order_regist_recept';
    protected $primaryKey = 't_goto_order_regist_recept_id';
