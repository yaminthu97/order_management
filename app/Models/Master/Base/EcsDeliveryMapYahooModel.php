...
/**
 * Class EcsDeliveryMapYahooModel
 *
 * @package App\Models
 */
class EcsDeliveryMapYahooModel extends Model
{
    protected $table = 'm_ecs_delivery_map_yahoo';
    protected $primaryKey = 'm_ecs_delivery_map_yahoo_id';
