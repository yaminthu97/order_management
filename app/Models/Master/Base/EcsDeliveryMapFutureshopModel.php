...
/**
 * Class EcsDeliveryMapFutureshopModel
 *
 * @package App\Models
 */
class EcsDeliveryMapFutureshopModel extends Model
{
    protected $table = 'm_ecs_delivery_map_futureshop';
    protected $primaryKey = 'm_ecs_delivery_map_futureshop_id';
