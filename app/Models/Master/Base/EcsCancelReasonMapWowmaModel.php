...
/**
 * Class EcsCancelReasonMapWowmaModel
 *
 * @package App\Models
 */
class EcsCancelReasonMapWowmaModel extends Model
{
    protected $table = 'm_ecs_cancel_reason_map_wowma';
    protected $primaryKey = 'm_ecs_cancel_reason_map_wowma_id';
