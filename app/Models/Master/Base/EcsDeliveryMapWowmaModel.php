...
/**
 * Class EcsDeliveryMapWowmaModel
 *
 * @package App\Models
 */
class EcsDeliveryMapWowmaModel extends Model
{
    protected $table = 'm_ecs_delivery_map_wowma';
    protected $primaryKey = 'm_ecs_delivery_map_wowma_id';
