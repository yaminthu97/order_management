...
/**
 * Class EcsCancelReasonMapAmazonModel
 *
 * @package App\Models
 */
class EcsCancelReasonMapAmazonModel extends Model
{
    protected $table = 'm_ecs_cancel_reason_map_amazon';
    protected $primaryKey = 'm_ecs_cancel_reason_map_amazon_id';
