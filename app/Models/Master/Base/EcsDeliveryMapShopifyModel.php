...
/**
 * Class EcsDeliveryMapShopifyModel
 *
 * @package App\Models
 */
class EcsDeliveryMapShopifyModel extends Model
{
    protected $table = 'm_ecs_delivery_map_shopify';
    protected $primaryKey = 'm_ecs_delivery_map_shopify_id';
