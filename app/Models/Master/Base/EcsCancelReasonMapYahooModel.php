...
/**
 * Class EcsCancelReasonMapYahooModel
 *
 * @package App\Models
 */
class EcsCancelReasonMapYahooModel extends Model
{
    protected $table = 'm_ecs_cancel_reason_map_yahoo';
    protected $primaryKey = 'm_ecs_cancel_reason_map_yahoo_id';
