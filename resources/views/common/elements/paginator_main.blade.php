<nav class="u-mt--sl d-table">
		...
		<li class="active"><span>1</span></li>
			...
			<li>
			<li><a href="javascript:void(0);" onClick="setNextPage({{$i}})">{{$i}}</a></li>
			</li>
			@endfor
		<li>
			<li><a href="javascript:void(0);" onClick="setNextPage(2)">次へ</a></li>
		</li>
		<li>
			<li><a href="javascript:void(0);" onClick="setNextPage({{$paginator->lastPage()}})">最後へ</a></li>
		</li>
		@endif
		@elseif($paginator->currentPage() == $paginator->lastPage())
			<li><a href="javascript:void(0);" onClick="setNextPage(1)">最初へ</a></li>
			<li><a href="javascript:void(0);" onClick="setNextPage({{$paginator->currentPage() - 1}})">前へ</a></li>
		...
		@else
			...
			@endfor
			<li><a href="javascript:void(0);" onClick="setNextPage({{$paginator->currentPage() + 1}})">次へ</a></li>
			<li>
				<li><a href="javascript:void(0);" onClick="setNextPage({{$paginator->lastPage()}})">最後へ</a></li>
			</li>
		@endif
