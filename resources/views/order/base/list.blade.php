...
<div>
	...
	<div class="c-box--800Half">
		<table class="table c-tbl c-tbl--790">
			<tbody>
				<tr>
					<th class="c-box--180">注文者氏名・カナ氏名</th>
					<td>
				...
				<tr>
					<th class="c-box--180">電話番号・FAX</th>
	...
	<div class="c-box--1600">
		<table class="table c-tbl c-tbl--1600 c-tbl-border-all">
			<tr>
				<th class="c-box--180 u-vam">検索に含めるタグ</th>
				<td class="u-vam">
					<div class="tag-box">
...
@push('js')
<script src="{{ esm_internal_asset('js/order/base/app.js') }}"></script>
@endpush
@endsection