        ...
        <table class="table table-bordered c-tbl c-tbl--800">
            ...
            <tr>
                ...
                <td>
                    ...
                    <label class="label-margin">
                        <input type="radio" name="delete_flg" value="{{ $delete_value }}" @checked(old('delete_flg', $records->delete_flg ?? null) == $delete_value)>
                        {{ $delete_label }}
            ...
            <tr>
                ...
                <td>
                    ...
                    <label class="label-margin">
                        <input type="radio" name="m_itemname_type" value="{{ $itemname_type_value }}" @checked(old('m_itemname_type', $records->m_itemname_type ?? null) == $itemname_type_value)>
                        {{ $itemname_type_label }}
                    </label>
                    @endforeach
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control c-box--300 label-margin" name="m_itemname_type_name" value="{{ old('m_itemname_type_name', $records->m_itemname_type_name ?? null) }}">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control c-box--300 label-margin" name="m_itemname_type_code" value="{{ old('m_itemname_type_code', $records->m_itemname_type_code ?? null) }}">
           ...
           <tr>
                ...
                <td>
                    <input type="text" class="form-control c-box--300 label-margin" name="m_itemname_type_sort" value="{{ old('m_itemname_type_sort', $records->m_itemname_type_sort ?? null) ?? '100'}}" >
